    ...
    return (
      <div style={{ maxWidth: 600, margin: "40px auto" }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          <Link href="/portal/vocabulary" className="btn btn-secondary btn-lg">Browse words</Link>
        </div>
        <div className="body-sm" style={{ textAlign: "center", marginTop: 14 }}>
          🔥 Studying today extends your {m.student.streak}-day streak
        </div>
      </div>
    )
  }
  ...
  if (done) {
    ...
    return (
      <div style={{ maxWidth: 520, margin: "40px auto", textAlign: "center" }}>
        ...
        <div className="body" style={{ marginBottom: 24 }}>Great work today, {m.student.firstName}.</div>
        <div className="grid-3" style={{ marginBottom: 24, textAlign: "left" as const }}>
          ...
          <LocalMetricCard label="Streak" value={m.student.streak + 1} icon="flame" accent="red" />
        </div>
        <Link href="/portal" className="btn btn-tenant btn-lg">Back to dashboard</Link>
      </div>
    )
  }
    ...
    <div style={{ maxWidth: 600, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
          ...
          <span className="body-sm">🔥 {m.student.streak}-day streak</span>
        </div>
