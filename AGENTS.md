...
| `AGENTS.md` | This file — AI behavior only. |
...
5. When work lands: update MASTER_PLAN §5 (known issues) and §7 (change log). **Attribution mandatory** — tag change-log entries `[Codex]` / `[DeepSeek V4 Pro]` / `[AI-Name]`.
