 ...
 */
/**
 * Admin-only lesson credit adjustment. Purchases are intentionally absent:
 * paid credits can only be created by the canonical billing order finalizer.
 */
export const grantLessonAdjustment = mutation({
  args: {
    studentId: v.string(),
    points: v.number(),
    source: v.union(
