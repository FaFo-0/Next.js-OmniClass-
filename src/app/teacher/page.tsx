...
export default function TeacherDashboard() {
  ...
  const t = {
    ...
    hoursThisMonth: lessons.reduce((sum, l) => sum + (l.durationSeconds ?? 0), 0) / 3600,
      ...
      <div className="split-2-1" style={{ marginBottom: 24 }}>
        <div className="card">
              ...
              todaysClasses.map((c) => (
                <div key={c._id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 0", borderBottom: "1px solid var(--omnic-gray-100)" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div className="body-sm">{c.studentId ?? "—"}</div>
                  </div>
          ...
          <div style={{ padding: 16 }}>
            ...
            {recordings.slice(0, 3).map((r) => (
              <div key={r._id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: "1px solid var(--omnic-gray-100)" }}>
                <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div className="grid-2">
            ...
            <MetricCard icon="clock" label="Hours taught" value={t.hoursThisMonth.toFixed(1)} />
            <MetricCard icon="video" label="Pending reviews" value={t.pendingReviews} />
          </div>
