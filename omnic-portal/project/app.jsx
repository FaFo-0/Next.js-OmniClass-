...
function OmnicLogo2({ tenantName }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      <svg width="34" height="34" viewBox="0 0 600 600" style={{ flexShrink: 0 }} aria-hidden="true">
        <g transform="translate(50 50)">
          <g transform="translate(0 0) scale(1.7)">
            <path d="M 183.88 219.563 C 183.88 321.05 101.486 403.444 0 403.444 C -101.486 403.444 -183.88 321.05 -183.88 219.563 C -183.88 118.077 -101.486 35.683 0 35.683 L 0 89.54 C -71.762 89.54 -130.023 147.802 -130.023 219.563 C -130.023 291.325 -71.762 349.586 0 349.586 C 71.762 349.586 130.023 291.325 130.023 219.563 L 183.88 219.563 Z" fill="#FFCA00" transform="translate(213 0)"/>
            <path d="M 0 35.683 C 101.486 35.683 183.88 118.077 183.88 219.563 L 130.023 219.563 C 130.023 147.802 71.762 89.54 0 89.54 L 0 35.683 Z" fill="#6716A4" transform="translate(213 0)"/>
          </g>
          <g transform="translate(0 290) scale(1.4)">
            <path d="M 0 0 L 0 137 L 137 137 C 137 212.66 75.66 274 0 274 C -75.66 274 -137 212.66 -137 137 C -137 61.34 -75.66 0 0 0 Z" fill="#6716A4" transform="translate(137 0)"/>
          </g>
        </g>
      </svg>
      <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.05 }}>
        <span style={{ fontFamily: 'Georgia, "Plantagenet Cherokee", serif', fontSize: 17, fontWeight: 700, color: 'var(--brand-purple)', letterSpacing: '-0.01em' }}>Omnica</span>
        <span style={{ fontFamily: 'Georgia, "Plantagenet Cherokee", serif', fontSize: 11, color: 'var(--brand-purple)', opacity: 0.7, letterSpacing: '0.02em', marginTop: 2 }}>.english</span>
      </div>
    </div>
  );
}
