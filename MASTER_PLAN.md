...
### Open
- Student onboarding captures `interests` and `preferredDays`/`preferredTimeOfDay`, but nothing reads them yet — wire interests into library recommendations and availability into the teacher's slot-painting hints.
