...
- **Not yet:** drag-to-paint ranges, drag lesson (click-move instead), timezone display conversion (users.timezone stored, display TBD), On Break/On Hold statuses (§13.7), old `/student/book` + student-dashboard booking section still on legacy points path — fold into calendar later.
